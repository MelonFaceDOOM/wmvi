...
from apps.claims.extraction.core import build_azure_claims_client, format_input_text, load_azure_config
...
# Legacy scored prompts (with-scores path); claims-only comes from nlp.claim_extraction.
...
if __name__ == "__main__":
    ap = argparse.ArgumentParser(prog="python -m apps.claims.extraction.get_claims")
