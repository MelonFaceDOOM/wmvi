"""Shared claim-extraction helpers (schemas, formatting, LLM client factories)."""
...
from apps.claims.extraction.scores import SCORE_FIELD_NAMES, parse_score_01
...
def build_azure_claims_client(
    *,
    ...
    from apps.claims.extraction.api_requester import AzureClaimsClient
...
def build_openai_claims_client(
    *,
    ...
    from apps.claims.extraction.api_requester import OpenAIClaimsClient
...
def openai_structured_completion(
    *,
    ...
    from apps.claims.extraction.api_requester import _create_structured_chat_completion
