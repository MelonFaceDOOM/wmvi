...
from apps.claim_extractor.refinement_lab import db, posts_data


def default_labeler_db_path() -> Path:
    return Path(__file__).resolve().parents[1] / "labeler_lab" / "data" / "lab.sqlite"
