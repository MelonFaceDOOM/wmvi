...
from apps.claim_extractor.refinement_lab import db, posts_data, prompt_vars, seed_import
...
def test_metrics_prf_and_aggregate() -> None:
    from apps.claim_extractor.refinement_lab import metrics
...
def test_render_meta_template() -> None:
    from apps.claim_extractor.refinement_lab.meta_defaults import render_meta_template
