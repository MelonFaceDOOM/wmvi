...
-- === POST SUMMARY VIEW  ===
-- ==========================
-- Unified summary of posts with basic metadata and filtered_text.
-- - primary_metric: main engagement metric per platform (likes/score/views/etc.)
-- - url: permalink / link where applicable
